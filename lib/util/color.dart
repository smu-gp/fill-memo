...
class AppColors {
  static final Color primaryColor = Color(0xFF212121);
  static final Color primaryColorLight = Colors.grey[900];
  static final Color primaryColorDark = Color(0xFF282828);
