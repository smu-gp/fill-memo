...
class SpannableEditableText extends StatefulWidget {
  ...
  ///
  /// The cursor refers to the blinking caret when the [SpannableEditableText] is focused.
  ///
  /// See also:
  ///
  ...
  ///
  /// The [SpannableEditableText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [SpannableEditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [SpannableEditableText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [SpannableEditableText], which
  ...
  @override
  SpannableEditableTextState createState() => SpannableEditableTextState();
...
/// State for a [SpannableEditableText].
class SpannableEditableTextState extends State<SpannableEditableText>
    with
        AutomaticKeepAliveClientMixin<SpannableEditableText>,
        WidgetsBindingObserver,
        TickerProviderStateMixin<SpannableEditableText>
  ...
  void initState() {
    ...
    if (widget.spannableController != null) {
      widget.spannableController.addListener(_didChangeSpannableTextStyle);
    }
  ...
  @override
  void didUpdateWidget(SpannableEditableText oldWidget) {
    ...
    if (widget.spannableController != null &&
        widget.spannableController != oldWidget.spannableController) {
      oldWidget.spannableController
          .removeListener(_didChangeSpannableTextStyle);
      widget.spannableController.addListener(_didChangeSpannableTextStyle);
    }
  ...
  void dispose() {
    ...
    if (widget.spannableController != null)
      widget.spannableController.removeListener(_didChangeSpannableTextStyle);
  ...
  void _startCursorTimer() {
    ...
    if (SpannableEditableText.debugDeterministicCursor) return;
    if (widget.cursorOpacityAnimates) {
      _cursorTimer =
  ...
  void _updateSpannableController() {
    if (widget.spannableController != null) {
      widget.spannableController.sourceText = _value.text;
      widget.spannableController.selection = _value.selection;
    }
  }
      ...
      viewportBuilder: (BuildContext context, ViewportOffset offset) {
        return CompositedTransformTarget(
          ...
          child: Semantics(
            ...
            child: _Editable(
              key: _editableKey,
              textSpan: widget.spannableController != null
                  ? widget.spannableController.getTextSpan(widget.style)
                  : buildTextSpan(),
              value: _value,
              cursorColor: _cursorColor,
              backgroundCursorColor: widget.backgroundCursorColor,
              showCursor: SpannableEditableText.debugDeterministicCursor
